...
void key_commit_attack_verify(){
    uint8_t K0[16] = {0x5f,0x72,0x59,0xb7,0x64,0x8a,0x80,0x67,0x12,0xb3,0x1b,0xd0,0xb2,0x66,0x74,0xb6};
    uint8_t K1[16] = {0x12,0x9e,0xb9,0xb7,0x64,0x8a,0x60,0x67,0x12,0xb3,0xfb,0xd0,0xb2,0x8a,0x74,0xb6};
    uint8_t IV[12] = {0x7d, 0x09, 0xd6, 0xf6, 0x5b, 0x91, 0x8f, 0x60, 0xc6, 0xd7, 0x02, 0x09};
    uint8_t add_data[16]={0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x01};
    uint8_t plaintext0[48] = {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x75,0xbe,0xd5,0x56,0x1c,0xb1,0xfa,0x35,0x23,0xb9,0x39,0xd4,0xe2,0x4e,0x39,0x72,0x43,0x16,0x10,0xb9,0x6f,0x4b,0x4c,0x25,0xe2,0x7f,0x2,0x3c,0x64,0x8c,0x51,0xe4};
    uint8_t plaintext1[48] = {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x65,0x54,0x20,0xd1,0x5e,0x6e,0xbf,0xda,0x7a,0xe3,0x8c,0xa,0x8d,0x3d,0x7d,0xce,0x71,0xe3,0xeb,0x9a,0xc3,0x3c,0xd0,0x1c,0x30,0x24,0x8c,0xf1,0x9e,0xe,0xf4,0xd0};
    uint8_t ciphertext0[48] = {0};
    uint8_t ciphertext1[48] = {0};
    uint8_t tag0[16] = {0};
    uint8_t tag1[16] = {0};
    aes128gcm(ciphertext0, tag0, K0, IV, 5, plaintext0, 3, add_data, 1);
    aes128gcm(ciphertext1, tag1, K1, IV, 5, plaintext1, 3, add_data, 1);
    printf("IV\n");
    for(int i = 0; i < 12; i++){
        printf("%02x ",IV[i]);
    }printf("\n");
